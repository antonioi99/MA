...
def main():
    ...
    helper_graphs.plot_facet_dotplot(df, output_file='figures/facet_dotplot_results.png')
    ...
    helper_graphs.plot_volcano(df, output_file='figures/scatter_volcano.png')
